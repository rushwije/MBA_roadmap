...
D$Ry <- rbinom(n, 1, expit(   param[param$para_name == 'Ry_b0', 2] + 
                                ...
                                param[param$para_name == 'Ry.dmode_b12', 2]*D$mode_delivery+
                                param[param$para_name == 'Ry.gest_b13', 2]*D$pre_term+
                                param[param$para_name == 'Ry.mage_b14', 2]*D$mother_age_atbirth+
                                param[param$para_name == 'Ry.SES2_b15', 2]*D$SEIFA_quint_1+
                                param[param$para_name == 'Ry.SES3_b16', 2]*D$SEIFA_quint_2+
                                param[param$para_name == 'Ry.SES4_b17', 2]*D$SEIFA_quint_3+
                                param[param$para_name == 'Ry.SES5_b18', 2]*D$SEIFA_quint_4+
                                param[param$para_name == 'Ry.msmok_b19', 2]*D$smoke_mother_pregnancyii+
